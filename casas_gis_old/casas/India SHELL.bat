...
set GISBASE=C:/Program Files/GRASS-64-SVN
...
echo  ************************************
echo    GRASS shell for the Med Basin
echo    running through a DOS box.
echo    For batch process, please type:
echo    "C:\Program Files\GRASS 6.4.SVN-r48083-1\msys\bin\sh.exe" batch_OliveProtheus.sh
echo  ************************************
echo.
