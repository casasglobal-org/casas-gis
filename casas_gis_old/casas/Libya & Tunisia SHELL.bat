...
chdir /D C:\cygwin\home\andy

set LC_ALL=C

rem Set GRASS Installation Directory Variable
set GRASSDIR=C:\Program Files\GRASS 6.4.SVN-r48083-1
set GISBASE=C:/Program Files/GRASS 6.4.SVN-r48083-1
...
set GIS_LOCK=1
set GRASS_VERSION=6.4.svn

set WD=%HOMEDRIVE%%HOMEPATH%
set UNIQUE=%RANDOM%
...
echo  ************************************
echo    GRASS shell for the LibyaTunisia
echo    running through a DOS box.
echo    For batch process, please type:
echo    "C:\Program Files\GRASS 6.4.SVN-r48083-1\msys\bin\sh.exe"
echo        batch_LibyaTunisia_screwworm.sh
echo  ************************************
echo.
