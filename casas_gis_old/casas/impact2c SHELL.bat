...
set GRASSDIR=C:\Program Files\GRASS GIS 6.4.4svn

set GISBASE=C:/Program Files/GRASS GIS 6.4.4svn
...
echo  ************************************
echo    GRASS shell for IMPACT2C
echo    running through a DOS box.
echo    For batch process, please type:
echo    "C:\Program Files\GRASS GIS 6.4.4svn\msys\bin\sh.exe" batch_OliveProtheus.sh
echo  ************************************
echo.
