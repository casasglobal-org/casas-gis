...
set GRASSDIR=C:\Program Files\GRASS GIS 6.4.4

set GISBASE=C:/Program Files/GRASS GIS 6.4.4
...
echo    "C:\Program Files\GRASS GIS 6.4.4\msys\bin\sh.exe" batch_OliveProtheus.sh
echo  ************************************
echo.
